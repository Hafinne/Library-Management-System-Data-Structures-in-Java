 ...
 *Handles File I/O for persistence via helper class
 */
public class Library {

    // --- Data Structures ---
    private DynamicArray catalog;   // main list to store books (Array) 
    private BST bookTree;           // BST for title-based searching 
    private Queue borrowRequests;   // queue for managing waiting list 
    private Stack undoStack;        // stack for undoing operations 
     ...
     * ttime Complexity: O(log n) average
     */
    ...
    /**
     * lists all books using dynamic array.
     * Time Complexity: O(n)
     */
    ...
    /**
     * Lists all books alphabetically using BST InOrder traversal.
     * Time Complexity: O(n)
     */
